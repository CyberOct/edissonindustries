...
export const SubtitleList = styled.div`
    display: ${({ showSubtitleList }) => (showSubtitleList ? 'block' : 'none ')}
   
`
export const SubtitleHeader = styled.p`
    text-transform:uppercase;
    color: rgb(161,162,162);
    font-weight:bold;
`
...
export const ListElement = styled.li`
    color: rgb(161,162,162);
    ${'' /* border-bottom: 1px solid rgb(161,162,162); */}
`
export const CheckBoxIcon = styled(ImCheckboxChecked)`
